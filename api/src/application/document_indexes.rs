...
#[diesel(table_name = document_indexes)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct DocumentIndexChangeset {
...
pub async fn get_document_index(
    ...
    document_indexes::table
        ...
        .first::<DocumentIndex>(db)
        .await
        .api_context("Failed to fetch document_index")
}

pub async fn get_document_index_by_slug(
    db: &mut PooledConnection<'_, AsyncDieselConnectionManager<AsyncPgConnection>>,
    slug: String,
) -> Result<DocumentIndex, ApiError> {
    document_indexes::table
...
pub async fn list_document_indexes(
    db: &mut PooledConnection<'_, AsyncDieselConnectionManager<AsyncPgConnection>>,
    params: ListDocumentIndexesQuery,
) -> Result<ResourceList<DocumentIndexView>, ApiError> {
